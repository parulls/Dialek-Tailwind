    ...
    <div class="container-fluid flex flex-wrap">
        <div class="row-span-12 md:row-span-4 ml-12 w-full md:w-1/3 flex justify-center">
            <div class="flex flex-col">
                <h1 class="text-5xl font-bold text-gradient font-poppins ml-9 mt-5">Bahasa Batak</h1>
                <a href="tanya.html">
            ...
            <div class="flex flex-row justify-around items-center font-inter space-x-7">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center justify-center w-24 h-24 rounded-full border-4 border-gray-700 mt-3">
                        <p class="text-3xl font-bold text-custom4">22%</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center justify-center w-24 h-24 rounded-full border-4 border-gray-700 mt-3">
                        <p class="text-3xl font-bold text-custom7">40</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center justify-center w-24 h-24 rounded-full border-4 border-gray-700 mt-3">
                        <p class="text-3xl font-bold text-custom7">2</p>
                    </div>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex items-center justify-center w-24 h-24 rounded-full border-4 border-gray-700 mt-3">
                        <p class="text-3xl font-bold text-custom7">75%</p>
                    </div>
                </div>
            </div>
